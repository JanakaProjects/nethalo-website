...
export function seed() {
  ...
  const users = [
    { id: 'u1', name: 'Alex Rivera', email: 'student@nationalhatecrime.com', password: pw, role: 'student', school: 'Manchester Academy', age: 16 },
    { id: 'u2', name: 'Sarah Thompson', email: 'parent@nationalhatecrime.com', password: pw, role: 'parent' },
    { id: 'u3', name: 'Dr. James Mitchell', email: 'admin@nationalhatecrime.com', password: pw, role: 'admin', school: 'Brighton College', admin_role: 'head' },
    { id: 'u4', name: 'Demo Student', email: 'demo@nationalhatecrime.com', password: pw, role: 'student', school: 'Central High', age: 15 },
    { id: 'u5', name: 'Demo Parent', email: 'demo-parent@nationalhatecrime.com', password: pw, role: 'parent' },
  ];
